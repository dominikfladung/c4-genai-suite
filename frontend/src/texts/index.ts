...
function load() {
  return {
    ...
    chat: {
      ...
      transcribe: {
        browserNotSupported: translate('chat.transcribe.browserNotSupported'),
        microphonePermissionDenied: translate('chat.transcribe.microphonePermissionDenied'),
        recordingStartFailed: translate('chat.transcribe.recordingStartFailed'),
        noAudioRecorded: translate('chat.transcribe.noAudioRecorded'),
        transcriptionFailed: translate('chat.transcribe.transcriptionFailed'),
        maxDurationReached: translate('chat.transcribe.maxDurationReached'),
        startRecording: translate('chat.transcribe.startRecording'),
        stopRecording: translate('chat.transcribe.stopRecording'),
        transcribing: translate('chat.transcribe.transcribing'),
      },
    ...
    extensions: {
      ...
      importConfigurationInvalidJson: translate('extensions.importConfigurationInvalidJson'),
